...
#pragma endregion				 
		...
		void loadTracks()
		{
			...
			for (int i = 0; i < filesCount; i++)
			{
				...
				if (ext == ".mp3" || ext == ".wav")//lọc ra file âm thanh trong folder đã chọn
				{
					trackList->Items->Add(fileName);//đưa tên các file âm thanh vào List
				}
		...
		void pausePlayer()
		{
			player->GetStatus(statusInfo);//lấy ra trạng thái của file âm thanh
			if (statusInfo.fPause || !statusInfo.fPlay) { return; }
			player->PausePlayback();
			player->GetStatus(statusInfo);
			playStopBtn->Text = "Play";//nút Stop chuyển thành Play, khi nhấn thì nhạc tiếp tục phát
		...
		void previousTrack()
		{
			if (trackList->Items->Count == 0) { return; }//Chắc chắn rằng danh sách không rỗng
			stopPlayer();
			trackListIndex--;
			if (trackListIndex < 0)//nếu không có file nào đứng trước nó
			{ trackListIndex = trackList->Items->Count - 1; }//chuyển tới file cuối cùng của danh sách
			trackList->SelectedIndex = trackListIndex;
			trackName = trackList->SelectedItem->ToString();
			playingTrack = soundsDirPath + "/" + trackName;//Gán đường dẫn vào biến chuyên dùng để load
			loadTrackFile(playingTrack);//Load biến chứa đường dẫn
			startPlayer();
		}
		...
		{
			player->SetMasterVolume(vol, vol);//khởi tạo âm lượng left & right như nhau
			masterVolume = vol;
			masterVolLbl->Text = vol.ToString();//hiển thị độ lớn của âm thanh
		...
		void setLeftRightVolume(int left, int right)
		{
			...
			leftVolume = left;
			rightVolume = right;
			leftVolBar->Value = left;//gán giá trị trên thanh volbar cho âm lượng 
			rightVolBar->Value = right;
			leftVolLbl->Text = left.ToString();//hiển thị giá trị độ lớn âm lượng
		...
		void setPTR(char cmd, int val)
		{
			...
			case 'P':
				...
				player->SetPitch(val);//khởi tạo val bằng pitch mặc định
				pitchValBar->Value = val;//giá trị trên thanh pitch thay đổi tới đâu val thay đổi tới đó
				pitchLbl->Text = val.ToString();//hiển thị độ lớn thanh pitch
				break;
			case 'T':
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// trackList
			// 
			this->trackList->BackColor = System::Drawing::Color::LightSlateGray;
			this->trackList->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(161)));
			this->trackList->ForeColor = System::Drawing::SystemColors::HighlightText;
			this->trackList->FormattingEnabled = true;
			this->trackList->HorizontalScrollbar = true;
			this->trackList->ItemHeight = 16;
			this->trackList->Items->AddRange(gcnew cli::array< System::Object^  >(1) { L"Playlist" });
			this->trackList->Location = System::Drawing::Point(-1, 37);
			this->trackList->Name = L"trackList";
			this->trackList->Size = System::Drawing::Size(464, 356);
			...
			// dirBtn
			// 
			this->dirBtn->Location = System::Drawing::Point(12, 8);
			...
			this->pathLbl->Location = System::Drawing::Point(113, 13);
			this->pathLbl->Name = L"pathLbl";
			this->pathLbl->Size = System::Drawing::Size(35, 13);
			this->pathLbl->TabIndex = 2;
			this->pathLbl->Text = L"Path=";
			this->pathLbl->Click += gcnew System::EventHandler(this, &PlayerForm::pathLbl_Click);
			// 
			// playBtnPanel
			// 
			this->playBtnPanel->BackColor = System::Drawing::Color::LightSlateGray;
			...
			this->playBtnPanel->Controls->Add(this->nextTrackBtn);
			this->playBtnPanel->Controls->Add(this->playStopBtn);
			this->playBtnPanel->Controls->Add(this->pauseBtn);
			this->playBtnPanel->Controls->Add(this->trackPosLbl);
			this->playBtnPanel->Controls->Add(this->prevTrackBtn);
			...
			this->playBtnPanel->Dock = System::Windows::Forms::DockStyle::Bottom;
			this->playBtnPanel->Font = (gcnew System::Drawing::Font(L"MV Boli", 9.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->playBtnPanel->Location = System::Drawing::Point(0, 402);
			this->playBtnPanel->Name = L"playBtnPanel";
			this->playBtnPanel->Size = System::Drawing::Size(879, 118);
			this->playBtnPanel->TabIndex = 3;
			this->playBtnPanel->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PlayerForm::playBtnPanel_Paint);
			// 
			// nextTrackBtn
			// 
			this->nextTrackBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Yi Baiti", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->nextTrackBtn->Location = System::Drawing::Point(731, 34);
			this->nextTrackBtn->Name = L"nextTrackBtn";
			this->nextTrackBtn->Size = System::Drawing::Size(50, 20);
			...
			this->playStopBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 10, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(161)));
			this->playStopBtn->Location = System::Drawing::Point(650, 26);
			...
			this->pauseBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(161)));
			this->pauseBtn->Location = System::Drawing::Point(559, 26);
			...
			this->trackPosLbl->Location = System::Drawing::Point(798, 70);
			...
			// prevTrackBtn
			// 
			this->prevTrackBtn->Font = (gcnew System::Drawing::Font(L"Microsoft Yi Baiti", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->prevTrackBtn->Location = System::Drawing::Point(504, 34);
			this->prevTrackBtn->Name = L"prevTrackBtn";
			this->prevTrackBtn->Size = System::Drawing::Size(50, 20);
			...
			this->barPosBack->Controls->Add(this->barPos);
			this->barPosBack->Cursor = System::Windows::Forms::Cursors::Hand;
			this->barPosBack->Location = System::Drawing::Point(487, 69);
			...
			this->barPos->Location = System::Drawing::Point(2, 3);
			...
			this->statusLbl->Location = System::Drawing::Point(20, 48);
			...
			this->totalTimeLbl->Location = System::Drawing::Point(8, 93);
			...
			this->yearLbl->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->yearLbl->ForeColor = System::Drawing::SystemColors::HighlightText;
			this->yearLbl->Location = System::Drawing::Point(215, 96);
			this->yearLbl->Name = L"yearLbl";
			this->yearLbl->Size = System::Drawing::Size(26, 18);
			...
			this->artistLbl->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->artistLbl->ForeColor = System::Drawing::SystemColors::HighlightText;
			this->artistLbl->Location = System::Drawing::Point(215, 66);
			this->artistLbl->Name = L"artistLbl";
			this->artistLbl->Size = System::Drawing::Size(26, 18);
			...
			this->titleLbl->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->titleLbl->Size = System::Drawing::Size(26, 18);
			...
			this->trackLbl->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 11.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->trackLbl->ForeColor = System::Drawing::SystemColors::HighlightText;
			this->trackLbl->Location = System::Drawing::Point(215, 7);
			this->trackLbl->Name = L"trackLbl";
			this->trackLbl->Size = System::Drawing::Size(26, 18);
			...
			this->label6->Location = System::Drawing::Point(9, 76);
			...
			this->label5->Font = (gcnew System::Drawing::Font(L"MV Boli", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label4->Font = (gcnew System::Drawing::Font(L"MV Boli", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"MV Boli", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"MV Boli", 9.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			...
			this->vuPanel1->BackColor = System::Drawing::Color::LightSlateGray;
			...
			this->vuPanel1->Location = System::Drawing::Point(799, 159);
			this->vuPanel1->Name = L"vuPanel1";
			this->vuPanel1->Size = System::Drawing::Size(79, 234);
			...
			// vuMeterR
			// 
			this->vuMeterR->BackColor = System::Drawing::Color::LightSlateGray;
			this->vuMeterR->Location = System::Drawing::Point(42, 40);
			this->vuMeterR->Name = L"vuMeterR";
			this->vuMeterR->Size = System::Drawing::Size(24, 189);
			this->vuMeterR->TabIndex = 2;
			// 
			// vuMeterL
			// 
			this->vuMeterL->BackColor = System::Drawing::Color::LightSlateGray;
			this->vuMeterL->Location = System::Drawing::Point(7, 40);
			this->vuMeterL->Name = L"vuMeterL";
			this->vuMeterL->Size = System::Drawing::Size(24, 189);
			...
			this->vuBack2->Size = System::Drawing::Size(24, 189);
			...
			this->vuBack1->Size = System::Drawing::Size(24, 189);
			this->vuBack1->TabIndex = 0;
			// 
			// backPanel
			// 
			this->backPanel->BackColor = System::Drawing::Color::LightSlateGray;
			this->backPanel->BorderStyle = System::Windows::Forms::BorderStyle::FixedSingle;
			this->backPanel->Controls->Add(this->equPanel);
			this->backPanel->Location = System::Drawing::Point(470, 38);
			this->backPanel->Name = L"backPanel";
			this->backPanel->Size = System::Drawing::Size(408, 115);
			this->backPanel->TabIndex = 5;
			// 
			// equPanel
			// 
			this->equPanel->BackColor = System::Drawing::Color::LightSlateGray;
			...
			this->equPanel->Location = System::Drawing::Point(2, 2);
			this->equPanel->Name = L"equPanel";
			this->equPanel->Size = System::Drawing::Size(402, 109);
			this->equPanel->TabIndex = 2;
			this->equPanel->Paint += gcnew System::Windows::Forms::PaintEventHandler(this, &PlayerForm::equPanel_Paint);
			// 
			// equFlatBtn
			// 
			...
			this->equCheck->ForeColor = System::Drawing::SystemColors::HighlightText;
			...
			this->b0->Scroll += gcnew System::EventHandler(this, &PlayerForm::b0_Scroll);
			this->b0->ValueChanged += gcnew System::EventHandler(this, &PlayerForm::band_ValueChanged);
			// 
			// masterPanel
			// 
			this->masterPanel->BackColor = System::Drawing::Color::LightSlateGray;
			...
			this->masterPanel->Location = System::Drawing::Point(470, 159);
			this->masterPanel->Name = L"masterPanel";
			this->masterPanel->Size = System::Drawing::Size(325, 234);
			...
			this->rateLbl->Location = System::Drawing::Point(275, 20);
			...
			this->tempoLbl->Location = System::Drawing::Point(233, 20);
			...
			this->pitchLbl->Location = System::Drawing::Point(193, 20);
			...
			// rateValBar
			// 
			this->rateValBar->BackColor = System::Drawing::Color::LightSlateGray;
			this->rateValBar->Location = System::Drawing::Point(277, 41);
			...
			this->rateValBar->Size = System::Drawing::Size(45, 188);
			...
			// tempoValBar
			// 
			this->tempoValBar->BackColor = System::Drawing::Color::LightSlateGray;
			this->tempoValBar->Location = System::Drawing::Point(237, 41);
			...
			this->tempoValBar->Size = System::Drawing::Size(45, 188);
			...
			// pitchValBar
			// 
			this->pitchValBar->BackColor = System::Drawing::Color::LightSlateGray;
			this->pitchValBar->Location = System::Drawing::Point(197, 41);
			...
			this->pitchValBar->Size = System::Drawing::Size(45, 188);
			...
			this->rightVolLbl->Location = System::Drawing::Point(139, 20);
			...
			this->leftVolLbl->Location = System::Drawing::Point(86, 20);
			...
			// rightVolBar
			// 
			this->rightVolBar->BackColor = System::Drawing::Color::LightSlateGray;
			this->rightVolBar->Location = System::Drawing::Point(119, 41);
			...
			this->rightVolBar->Size = System::Drawing::Size(45, 188);
			this->rightVolBar->TabIndex = 19;
			this->rightVolBar->Scroll += gcnew System::EventHandler(this, &PlayerForm::leftRightVolBar_Scroll);
			// 
			// leftVolBar
			// 
			this->leftVolBar->BackColor = System::Drawing::Color::LightSlateGray;
			this->leftVolBar->Location = System::Drawing::Point(90, 41);
			...
			this->leftVolBar->Size = System::Drawing::Size(45, 188);
			...
			this->masterVolLbl->Location = System::Drawing::Point(13, 20);
			...
			// masterVolBar
			// 
			this->masterVolBar->BackColor = System::Drawing::Color::LightSlateGray;
			this->masterVolBar->Location = System::Drawing::Point(16, 41);
			...
			this->masterVolBar->Size = System::Drawing::Size(45, 188);
			...
			this->Description->Font = (gcnew System::Drawing::Font(L"MV Boli", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->Description->Location = System::Drawing::Point(694, 10);
			this->Description->Name = L"Description";
			this->Description->Size = System::Drawing::Size(179, 17);
			this->Description->TabIndex = 7;
			this->Description->Text = L"Developed by Tabs from CLBK";
			this->Description->Click += gcnew System::EventHandler(this, &PlayerForm::Description_Click);
			// 
			// PlayerForm
			// 
			this->AutoScaleDimensions = System::Drawing::SizeF(6, 13);
			this->AutoScaleMode = System::Windows::Forms::AutoScaleMode::Font;
			this->ClientSize = System::Drawing::Size(879, 520);
			...
			this->barPosBack->ResumeLayout(false);
...
#pragma endregion
	...
	{
		folderBrowserDialog->ShowDialog();//mở hộp thoại duyệt file
		soundsDirPath = folderBrowserDialog->SelectedPath->ToString();//lấy ra thành phần cần thiết
		print(soundsDirPath);
		loadTracks();//duyệt các file thông qua các thành phần vừa lấy ra
	}
	...
	private: System::Void pathLbl_Click(System::Object^  sender, System::EventArgs^  e) {
	}
private: System::Void equPanel_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
}
private: System::Void b0_Scroll(System::Object^  sender, System::EventArgs^  e) {
}
private: System::Void playBtnPanel_Paint(System::Object^  sender, System::Windows::Forms::PaintEventArgs^  e) {
}
